export const MAX_MAP_SPEED = 2000;
export const MIN_MAP_SPEED = 100;

export const INIT_WIDTH = 26;
export const INIT_HEIGHT = 26;
export const INIT_X = 13;
export const INIT_Y = 13;
export const INIT_SPEED = 300;

export const preyExampleMoveMap1 = [['empty'], ['empty', 'prey', 'empty'], ['empty']];
...
export const predatorExampleReplicationMap1 = [['prey'], ['prey', 'predator', 'prey'], ['prey']];
